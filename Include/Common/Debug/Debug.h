...
#ifndef DEBUG_LEVEL
#define DEBUG_LEVEL                         DEBUG_LEVEL_NONE//DEBUG_LEVEL_ERROR   ///< debug level there are DEBUG_LEVEL_NONE/DEBUG_LEVEL_ERROR/DEBUG_LEVEL_WARNING/DEBUG_LEVEL_INDICATION can be select
#endif
