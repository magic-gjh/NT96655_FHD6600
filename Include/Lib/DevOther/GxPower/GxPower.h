...
typedef enum _GXCUSTOM_CTRL
{
    GXCUSTOM_CTRL_AUTOLCDOFF_TIME = 0,          ///<  auto power off system time value set, get
    GXCUSTOM_CTRL_AUTOLCDOFF_EN,                ///<  system auto power off enable, disable
    GXCUSTOM_CTRL_AUTOLCDOFF_RESET,             ///<  battery detect function enable, disable
    GXCUSTOM_CTRL_DELAYOFF_TIME,                ///<  auto power off system time value set, get
    GXCUSTOM_CTRL_DELAYOFF_EN,                  ///<  system auto power off enable, disable
    GXCUSTOM_CTRL_DELAYOFF_RESET,               ///<  battery detect function enable, disable
    GXCUSTOM_CTRL_GPS_TIME,                     ///<  auto power off system time value set, get
    GXCUSTOM_CTRL_GPS_EN,                       ///<  system auto power off enable, disable
    GXCUSTOM_CTRL_GPS_RESET,                    ///<  battery detect function enable, disable
    
    ENUM_DUMMY4WORD(GXCUSTOM_CTRL)
}GXCUSTOM_CTRL;
/**
...
*/
extern void     GxPower_PowerON(void);
