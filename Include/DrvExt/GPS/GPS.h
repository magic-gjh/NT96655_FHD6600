...
extern void AIR_InstallID(void);
...
extern ER DGDRec_Open(UART_BAUDRATE BaudRateUart2);
extern ER DGDRec_Close(void);


extern BOOL StartAIRLink(void);
extern void Set_AIR_LINKSTATUS(BOOL Enb);
extern UINT32 Get_PM_Data(void);
extern UINT32 Get_AIR_LINK_CNT(void);
extern BOOL Get_AIR_LINKSTATUS(void);

extern UINT32 _SECTION(".kercfg_data") GPSRECEIVE_ID; // GPS Task
extern UINT32 _SECTION(".kercfg_data") FLG_ID_GPS; // GPS Flag

extern UINT32 _SECTION(".kercfg_data")  AIR_ID;
extern UINT32 _SECTION(".kercfg_data") FLG_ID_AIR; // GPS Flag
#endif
