...
SENSOR_INIT_OBJ DrvSensor_GetObj2nd(void)
{
    ...
    gpio_setDir(D_GPIO_5,GPIO_DIR_OUTPUT);
    gpio_setDir(D_GPIO_6,GPIO_DIR_OUTPUT);

    gpio_setPin(P_GPIO_36);
    Delay_DelayMs(100);
    gpio_clearPin(D_GPIO_5);
    Delay_DelayMs(100);
    gpio_setPin(D_GPIO_6);
...
{
    gpio_setDir(GPIO_SENSOR_PWM0, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWM0);
    gpio_setDir(GPIO_SENSOR_PWM1, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWM1);
    gpio_setDir(GPIO_SENSOR_PWM2, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWM2);
    gpio_setDir(GPIO_SENSOR_RESET, GPIO_DIR_OUTPUT);
    gpio_clearPin(GPIO_SENSOR_RESET);
