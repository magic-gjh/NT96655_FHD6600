...
#define VOLDET_KEY_ADC_LVL1         (173-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2         (346-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (514-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (653-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (653+VOLDET_KEY_ADC_RANGE)
  ...
  //  if (uiKey1ADC <1000)
   //     debug_msg("uiKey1ADC %d \r\n", uiKey1ADC);
    if (uiKey1ADC < VOLDET_KEY_ADC_TH)
    {
        ...
        {
            uiCurKey2Lvl = VOLDET_KEY_LVL_MENU;//VOLDET_KEY_LVL_MODE;
        }		
        else
        {
