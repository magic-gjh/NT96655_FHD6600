...
#define TV_DET_CTRL                 TV_DET_BY_GPIO
#if (TV_DET_CTRL == TV_DET_BY_GPIO)
#define GPIO_TV_PLUG                D_GPIO_3//P_GPIO_39
#define PAD_TV_PLUG                 PAD_PIN_DGPIO3//PAD_PIN_PGPIO39
#endif
...
extern BOOL GPIOMap_DCDet(void);
extern BOOL IS_TurnONLCDBacklight(void);
...
// Wi-Fi power
#define GPIO_WIFI_POWER_PWM5        P_GPIO_41//C_GPIO_15//P_GPIO_41
...
#define GPIO_RED_LED                P_GPIO_43//P_GPIO_36
#define PAD_RED_LED                 PAD_PIN_PGPIO43//PAD_PIN_PGPIO36

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_GREEN_BY_GPIO
#define GPIO_GREEN_LED              P_GPIO_39
#define PAD_GREEN_LED               PAD_PIN_PGPIO39
...
#define GPIO_DC_DET 	P_GPIO_47
#define PAD_DC_DET                 PAD_PIN_PGPIO47


#define GPIO_WIFI_LED              P_GPIO_40//GPIO_36
#define PAD_WIFI_LED               PAD_PIN_PGPIO40//D_PIN_PGPIO36

#define GPIO_KEY_BACKLIGHT_LED              P_GPIO_36
#define PAD_KEY_BACKLIGHT_LED               PAD_PIN_PGPIO36

#define GPIO_GPS_DET 	D_GPIO_6
#define PAD_GPS_DET                 PAD_PIN_DGPIO6

#define GPIO_LDWS_BEEP            P_GPIO_42
#define GPIO_DOG 	P_GPIO_51
//--------------------------------------------------------------------
// Power device
//--------------------------------------------------------------------
//Battery
...
//--------------------------------------------------------------------
// Sensor
#define GPIO_SENSOR_RESET           D_GPIO_7//S_GPIO_26//D_GPIO_7
#define GPIO_SENSOR_PWM0           P_GPIO_37// P_GPIO_50
#define GPIO_SENSOR_PWM1            P_GPIO_38//P_GPIO_51
// CCD
/*
typedef enum
{
...
extern BOOL DetGPS_IO(void);

extern void SetDog_Gpio(BOOL Enb);
extern BOOL GetDog_Gpio(void);

extern void TurnOnWifiLed(void);

extern void TurnOffWifiLed(void);
extern BOOL IsWifiLed(void);
extern BOOL IsKEY_BACKLIGHTLed(void);
extern void TurnOnKEY_BACKLIGHTLed(void);
extern void TurnOffKEY_BACKLIGHTLed(void);


extern void GPIO_Set_LDWS_BEEP(BOOL  Enb);
extern BOOL GPIO_Get_LDWS_BEEP(void);
//--------------------------------------------------------------------
// Storbe device
//--------------------------------------------------------------------
// STROBE
