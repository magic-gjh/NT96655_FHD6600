...
void ExifVendor_Write0thIFD(void)
{
    UINT32 i;
    ...
    {
        Exif_SetTag(&ZerothIFDTag[i]);
    }

}
void ExifVendor_WriteExifIFD(void)
{
    UINT32   i;
    ...
    */
    ...
    {
        Exif_SetTag(&ExifIFDTag[i]);
    }

}
void ExifVendor_Write0thIntIFD(void)
{
    UINT32 i;
