...
//WIFI_CMD_ITEM(WIFIAPP_CMD_GETDVRINFO,0,(UINT32)XML_DVR_Info,0, FL_NULL)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_HZ    ,NVTEVT_WIFI_EXE_HZ, 0,0, FL_FREQUENCY)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GETRTPSTATUS, 0,(UINT32)XML_GetRTPSTATUS, 0, FL_NULL)
