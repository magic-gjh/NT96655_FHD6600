...
#define WIFIAPP_CMD_MOVIE_AWB      2019
...
#define WIFIAPP_CMD_GETDVRINFO           8888
#define WIFIAPP_CMD_GETRTPSTATUS           6666
//@}
...
#define WIFIFLAG_MOVIE_REC_RAWENC_DONE       FLGPTN_BIT(6) //0x00000080
