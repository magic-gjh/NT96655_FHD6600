...
BOOL TV_Change_REC_Status = FALSE;

void Set_TV_REC_status(BOOL Enb)
{
    TV_Change_REC_Status = Enb;
}

BOOL Get_TV_REC_status(void)
{
    return TV_Change_REC_Status;
}
