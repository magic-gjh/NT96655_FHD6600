...
#define POOL_SIZE_STORAGE_RAMDISK  ALIGN_CEIL_32(0x8000)     // 32K bytes for RAM Disk.
#else
...
#if (_INTERSTORAGE_ == _INTERSTORAGE_SPI_)
#define POOL_SIZE_PS_BUFFER     (ALIGN_CEIL_32(0x1000)+ALIGN_CEIL_32(0x1800)) // 10K bytes = 1 block size + about 6K work
#else
...
#define POOL_SIZE_GFX_TEMP      ALIGN_CEIL_32(POOL_SIZE_DISP_VDO2+(0x1000)) //at least 4k for Gxlib
...
#if USE_FILEDB
#define POOL_SIZE_FILEDB        ALIGN_CEIL_32(0x200000)
#else
...
#define POOL_SIZE_CAL           ALIGN_CEIL_32(0x100000)
