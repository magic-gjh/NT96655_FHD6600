...
SHOW_ITEM_GROUP(CMD_Group,Normal2,10,0,37,27)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiModuleLink_StaticICN_WiFi,0,10,0,37,27)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin11Rect,0,0,239,27,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text13,0,0,239,27,STRID_NULL,0,0,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal10)
SHOW_MAP_BODY(Skin11)
SHOW_MAP_BODY(Text13)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal10,38,0,277,27)
...
CREATE_STATE_CTRL(UIMenuWndWiFiModuleLink_StatusTXT_WiFiMode,0,38,0,277,27)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin17Rect,0,0,309,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin17)
SHOW_MAP_BODY(Skin17Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin17,0,0,309,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text19,0,0,309,27,STRID_NULL,0,0,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal16)
SHOW_MAP_BODY(Skin17)
SHOW_MAP_BODY(Text19)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal16,10,65,319,92)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiModuleLink_StaticTXT_SSID,0,10,65,319,92)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin22Rect,0,0,309,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin22)
SHOW_MAP_BODY(Skin22Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin22,0,0,309,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text24,0,0,309,27,STRID_NULL,0,0,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal21)
SHOW_MAP_BODY(Skin22)
SHOW_MAP_BODY(Text24)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal21,10,93,319,120)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiModuleLink_StaticTXT_Key,0,10,93,319,120)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin26Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin28Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text30,0,0,104,79,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin32Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text34,0,0,104,79,STRID_NULL,0,0,0,0,7,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin36Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text38,0,0,104,79,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin40Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text42,0,0,104,79,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin44Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text46,0,0,104,79,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin49Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text51,0,0,104,79,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin53Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text55,0,0,104,79,STRID_NULL,0,0,0,0,7,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin57Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text59,0,0,104,79,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin61Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text63,0,0,104,79,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin65Rect,0,0,104,79,0,0,0,0,0,0,0)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text67,0,0,104,79,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
