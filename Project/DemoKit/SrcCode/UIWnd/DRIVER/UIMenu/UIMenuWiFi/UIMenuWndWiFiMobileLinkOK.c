...
INT32 UIMenuWndWiFiMobileLinkOK_Gsensor(VControl *, UINT32, UINT32 *);
INT32 UIMenuWndWiFiMobileLinkOK_OnKeyUP(VControl *, UINT32, UINT32 *);
INT32 UIMenuWndWiFiMobileLinkOK_OnMovieFinish(VControl *, UINT32, UINT32 *);
INT32 UIMenuWndWiFiMobileLinkOK_OnExeHZ(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_WIFI_EXE_HZ,UIMenuWndWiFiMobileLinkOK_OnExeHZ)
...
EVENT_ITEM(NVTEVT_CB_MOVIE_REC_FINISH,UIMenuWndWiFiMobileLinkOK_OnMovieFinish)
EVENT_ITEM(NVTRET_PROTECT,UIMenuWndWiFiMobileLinkOK_Gsensor)
...
INT32 UIMenuWndWiFiMobileLinkOK_OnOpen(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    UxCtrl_SetShow(&UIMenuWndWiFiMobileLinkOK_StaticTXT_MACCtrl, FALSE);
    UxStatic_SetData(&UIMenuWndWiFiMobileLinkOK_StaticTXT_MACCtrl,STATIC_VALUE,Txt_Pointer(StringMacBuf));
    UxCtrl_SetShow(&UIMenuWndWiFiMobileLinkOK_StaticTXT_MACCtrl, TRUE);
    Ux_RedrawAllWind();
...
INT32 UIMenuWndWiFiMobileLinkOK_OnExeHZ(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
INT32 UIMenuWndWiFiMobileLinkOK_OnExeSetSSID(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    if(paramNum)
    {
        ...
        Ux_SendEvent(0,NVTEVT_EXE_WIFI_SET_SSID, 1, Data);
    }
    return NVTEVT_CONSUME;
}
...
INT32 UIMenuWndWiFiMobileLinkOK_OnExeSetPassphrase(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    {
        Data = (char *)paramArray[0];
        Ux_SendEvent(0,NVTEVT_EXE_WIFI_SET_PASSPHRASE, 1, Data);
    }
    return NVTEVT_CONSUME;
}
...
INT32 UIMenuWndWiFiMobileLinkOK_Gsensor(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
     if(g_bgsensor==FALSE)
     {
	g_bgsensor = TRUE;     
...
INT32 UIMenuWndWiFiMobileLinkOK_OnMovieFinish(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyEnter)
EVENT_END
