...
extern UINT32 Get_BShutterValue(UINT32 uhIndex);
extern UINT32 Get_DSCmodeFromValue(UINT32 value);
extern UINT32 Get_DateImprintScaleValue(UINT32 value);
extern UINT32 Get_BlinkValue(UINT32 value);
extern UINT32 Get_ImageRatioValue(UINT32 value);
extern UINT32 Get_DatePrintValue(UINT32 value);
extern UINT32 Get_DscModeValue(UINT32 value);
