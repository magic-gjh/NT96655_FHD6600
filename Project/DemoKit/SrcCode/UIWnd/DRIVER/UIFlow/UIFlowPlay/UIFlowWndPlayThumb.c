...
EVENT_ITEM(NVTEVT_KEY_UP,UIFlowWndPlayThumb_OnKeyLeft)
EVENT_ITEM(NVTEVT_KEY_DOWN,UIFlowWndPlayThumb_OnKeyRight)
...
EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIFlowWndPlayThumb_OnKeyEnter)
EVENT_END
