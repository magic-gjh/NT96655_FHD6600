...
CREATE_STATE_ITEM_DATA(ICON_CYCLIC_REC_2MIN10,STRID_NULL,ICON_CYCLIC_REC_2MIN,NULL) 
...
STATE_LIST_ITEM(ICON_CYCLIC_REC_2MIN10)
...
CREATE_STATE_ITEM_DATA(ICONID_NULL16,STRID_NULL,ICON_MOTION_OFF,NULL) 
CREATE_STATE_ITEM_DATA(ICON_FLASH_REC17,STRID_NULL,ICON_MOTION_ON,NULL) 
...
SHOW_ITEM_GROUP(CMD_Group,Normal91,12,214,39,241)

CREATE_STATE_ITEM_DATA(ICONID_NULL94,STRID_NULL,ICON_VOICE_OFF,NULL) 
CREATE_STATE_ITEM_DATA(ICON_FLASH_REC95,STRID_NULL,ICON_VOICE_ON,NULL) 
...
STATE_LIST_ITEM(ICONID_NULL94)
STATE_LIST_ITEM(ICON_FLASH_REC95)
STATE_LIST_END

CREATE_STATE_DATA(UIFlowWndMovie_StatusICN_Audio,0)
CREATE_STATE_CTRL(UIFlowWndMovie_StatusICN_Audio,0,12,214,39,241)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon98, 0, 0, 27,27, ICONID_NULL,83886080,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal96)
SHOW_MAP_BODY(Skin97)
SHOW_MAP_BODY(Icon98)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal96,280,71,307,98)

CREATE_STATE_ITEM_DATA(ICON_GPS_NS99,STRID_NULL,ICON_GPS_NS,NULL) 
CREATE_STATE_ITEM_DATA(ICON_GPS_NC100,STRID_NULL,ICON_GPS_NC,NULL) 
CREATE_STATE_ITEM_DATA(ICON_GPS_OK101,STRID_NULL,ICON_GPS_OK,NULL) 
...
STATE_LIST_ITEM(ICON_GPS_NS99)
STATE_LIST_ITEM(ICON_GPS_NC100)
STATE_LIST_ITEM(ICON_GPS_OK101)
STATE_LIST_END

CREATE_STATE_DATA(UIFlowWndMovie_Status_GPS,0)
CREATE_STATE_CTRL(UIFlowWndMovie_Status_GPS,0,280,71,307,98)
...
SHOW_ITEM_GROUP(CMD_Group,Normal102,153,5,180,32)

CREATE_STATE_ITEM_DATA(ICON_GSENSOR_OFF105,STRID_NULL,ICON_GSENSOR_OFF,NULL) 
CREATE_STATE_ITEM_DATA(ICON_GSENSOR_L106,STRID_NULL,ICON_GSENSOR_L,NULL) 
CREATE_STATE_ITEM_DATA(ICON_GSENSOR_M107,STRID_NULL,ICON_GSENSOR_M,NULL) 
CREATE_STATE_ITEM_DATA(ICON_GSENSOR_H108,STRID_NULL,ICON_GSENSOR_H,NULL) 
...
STATE_LIST_ITEM(ICON_GSENSOR_OFF105)
STATE_LIST_ITEM(ICON_GSENSOR_L106)
STATE_LIST_ITEM(ICON_GSENSOR_M107)
STATE_LIST_ITEM(ICON_GSENSOR_H108)
STATE_LIST_END
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
SHOW_ITEM_RECT(CMD_Rectangle,Skin123Rect,0,0,199,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin123)
SHOW_MAP_BODY(Skin123Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin123,0,0,199,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text125,0,0,199,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal122)
SHOW_MAP_BODY(Skin123)
SHOW_MAP_BODY(Text125)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal122,12,166,211,193)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_StaticTXT_Speed,0,12,166,211,193)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon115, 0, 0, 47,47, ICONID_NULL,83886080,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal113)
SHOW_MAP_BODY(Skin114)
SHOW_MAP_BODY(Icon115)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal113,146,104,173,131)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_Lock,0,146,104,173,131)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_GROUP(CMD_Group,Skin191,0,0,399,239)
