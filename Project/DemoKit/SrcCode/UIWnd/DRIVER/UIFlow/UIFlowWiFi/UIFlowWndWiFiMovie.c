...
INT32 UIFlowWndWiFiMovie_OnExeMovieKeyRec(VControl *, UINT32, UINT32 *);
...
INT32 UIFlowWndWiFiMovie_OnExeMovieKeyRec(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    BOOL startRec =0;
...
INT32 UIFlowWndWiFiMovie_OnExeMovieRec(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    debug_msg("UIFlowWndWiFiMovie_OnExeMovieRec:%x,%x..\r\n",paramNum,startRec);
    ...
    if (UI_GetData(FL_CardStatus) != CARD_INSERT)
    {
        WifiCmd_Done(WIFIFLAG_RECORD_DONE,WIFIAPP_RET_FAIL);
        UIFlowWndWiFiMovieErrMsg("please check strage card..\r\n");
        return NVTEVT_CONSUME;
    }
...
INT32 UIFlowWndWiFiMovie_OnExeMovieLiveviewStart(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    if (System_GetState(SYS_STATE_CURRMODE) != PRIMARY_MODE_MOVIE)
    {
        WifiCmd_Done(WIFIFLAG_PREVIEW_DONE, WIFIAPP_RET_FAIL);
        UIFlowWndWiFiMovieErrMsg("not movie mode\r\n");
        return NVTEVT_CONSUME;
    }
...
INT32 UIFlowWndWiFiMovie_OnMovieFull(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    if (CheckStorageErr == TRUE) // storage may be not full, but reach the condition of FAT file size limit
    {
...
UINT32 UIFlowWiFiMovie_GetMaxRecTime(void)
{
    ...
    setting.audCodec = MEDIAREC_ENC_PCM;
    setting.audChs = 1;
    ...
    sec = MediaRec_CalcSecBySetting(&setting);
